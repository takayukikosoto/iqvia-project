...
-- Step 1: Create roles schema and user_roles table
...
-- Step 2: Create function to sync role to app_metadata
...
-- Step 3: Create function to assign role
...
-- Step 4: Update RLS policies to use JWT app_metadata (same pattern as admin)
