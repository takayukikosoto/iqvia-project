...
--
-- Name: messages_2025_08_20; Type: TABLE; Schema: realtime; Owner: supabase_admin
--
...
ALTER TABLE realtime.messages_2025_08_20 OWNER TO supabase_admin;
...
--
-- Name: messages_2025_08_20; Type: TABLE ATTACH; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2025_08_20 messages_2025_08_20_pkey; Type: CONSTRAINT; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: idx_chat_messages_project_created; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: messages_2025_08_20_pkey; Type: INDEX ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: chat_messages chat_messages_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: chat_messages Users can delete own chat messages; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can delete own chat messages" ON public.chat_messages FOR DELETE USING ((user_id = auth.uid()));
...
--
-- Name: chat_messages Users can insert project chat messages; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can insert project chat messages" ON public.chat_messages FOR INSERT WITH CHECK ((user_id = auth.uid()));
...
CREATE POLICY "Users can update own chat messages" ON public.chat_messages FOR UPDATE USING ((user_id = auth.uid()));
...
--
-- Name: chat_messages Users can view project chat messages; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can view project chat messages" ON public.chat_messages FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.project_memberships pm
  WHERE ((pm.project_id = chat_messages.project_id) AND (pm.user_id = auth.uid())))));
...
--
-- Name: TABLE messages_2025_08_20; Type: ACL; Schema: realtime; Owner: supabase_admin
--

GRANT ALL ON TABLE realtime.messages_2025_08_20 TO postgres;
GRANT ALL ON TABLE realtime.messages_2025_08_20 TO dashboard_user;
