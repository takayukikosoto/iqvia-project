...
--
-- Name: permission_definitions permission_definitions_permission_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.permission_definitions
    ADD CONSTRAINT permission_definitions_permission_name_key UNIQUE (permission_name);
...
--
-- Name: role_definitions role_definitions_role_level_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.role_definitions
    ADD CONSTRAINT role_definitions_role_level_key UNIQUE (role_level);


--
-- Name: role_definitions role_definitions_role_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: role_permissions role_permissions_role_name_permission_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.role_permissions
    ADD CONSTRAINT role_permissions_permission_name_fkey FOREIGN KEY (permission_name) REFERENCES public.permission_definitions(permission_name);
...
ALTER TABLE ONLY public.role_permissions
    ADD CONSTRAINT role_permissions_role_name_fkey FOREIGN KEY (role_name) REFERENCES public.role_definitions(role_name);
...
--
-- Name: events events_create; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY events_create ON public.events FOR INSERT WITH CHECK (public.has_permission(auth.uid(), 'events_create'::character varying));


--
-- Name: events events_delete; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY events_delete ON public.events FOR DELETE USING ((public.has_permission(auth.uid(), 'events_delete'::character varying) OR (owner_user_id = auth.uid())));
...
--
-- Name: events events_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY events_read ON public.events FOR SELECT USING ((public.has_permission(auth.uid(), 'events_read'::character varying) OR (owner_user_id = auth.uid())));
...
--
-- Name: events events_update; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY events_update ON public.events FOR UPDATE USING ((public.has_permission(auth.uid(), 'events_update'::character varying) OR (owner_user_id = auth.uid())));
...
--
-- Name: organizations organizations_create; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY organizations_create ON public.organizations FOR INSERT WITH CHECK (public.has_permission(auth.uid(), 'organizations_create'::character varying));


--
-- Name: organizations organizations_delete; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY organizations_delete ON public.organizations FOR DELETE USING (public.has_permission(auth.uid(), 'organizations_delete'::character varying));


--
-- Name: organizations organizations_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY organizations_read ON public.organizations FOR SELECT USING ((public.has_permission(auth.uid(), 'organizations_read'::character varying) OR (EXISTS ( SELECT 1
   FROM public.organization_memberships om
  WHERE ((om.org_id = organizations.id) AND (om.user_id = auth.uid()))))));


--
-- Name: organizations organizations_update; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY organizations_update ON public.organizations FOR UPDATE USING (public.has_permission(auth.uid(), 'organizations_update'::character varying));


--
-- Name: permission_definitions; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.permission_definitions ENABLE ROW LEVEL SECURITY;

--
-- Name: permission_definitions permission_definitions_read_all; Type: POLICY; Schema: public; Owner: postgres
--
...
CREATE POLICY profiles_admin_manage ON public.profiles USING ((EXISTS ( SELECT 1
   FROM auth.users u
  WHERE ((u.id = auth.uid()) AND ((u.role)::text = 'admin'::text)))));


--
-- Name: profiles profiles_own_manage; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY profiles_own_manage ON public.profiles USING ((auth.uid() = user_id));
...
--
-- Name: projects projects_create; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY projects_create ON public.projects FOR INSERT WITH CHECK (public.has_permission(auth.uid(), 'projects_create'::character varying));


--
-- Name: projects projects_delete; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY projects_delete ON public.projects FOR DELETE USING (public.has_permission(auth.uid(), 'projects_delete'::character varying));


--
-- Name: projects projects_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY projects_read ON public.projects FOR SELECT USING ((public.has_permission(auth.uid(), 'projects_read'::character varying) OR (EXISTS ( SELECT 1
   FROM public.project_memberships pm
...
CREATE POLICY projects_update ON public.projects FOR UPDATE USING ((public.has_permission(auth.uid(), 'projects_update'::character varying) OR (created_by = auth.uid())));
...
--
-- Name: role_definitions role_definitions_read_all; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: role_permissions role_permissions_read_all; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: tasks tasks_create; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY tasks_create ON public.tasks FOR INSERT WITH CHECK (public.has_permission(auth.uid(), 'tasks_create'::character varying));
...
CREATE POLICY tasks_delete ON public.tasks FOR DELETE USING (public.has_permission(auth.uid(), 'tasks_delete'::character varying));


--
-- Name: tasks tasks_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY tasks_read ON public.tasks FOR SELECT USING ((public.has_permission(auth.uid(), 'tasks_read'::character varying) OR (EXISTS ( SELECT 1
   FROM public.project_memberships pm
...
CREATE POLICY tasks_update ON public.tasks FOR UPDATE USING ((public.has_permission(auth.uid(), 'tasks_update'::character varying) OR (created_by = auth.uid())));
...
--
-- Name: TABLE permission_definitions; Type: ACL; Schema: public; Owner: postgres
--
